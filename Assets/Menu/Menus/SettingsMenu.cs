...
public class SettingsMenu : MonoBehaviour {
    ...
    void Start() {
        ...
        AddDoubleSliderToSection("Entity Body Size Dependencies", "Digestion Rate", SimulationScript.Instance.CoSh.MinDigestionRate, SimulationScript.Instance.CoSh.MaxDigestionRate, false, 1f, 40f, (min, max) => { SimulationScript.Instance.CoSh.MinDigestionRate = min; SimulationScript.Instance.CoSh.MaxDigestionRate = max; });
        ...
        AddDoubleSliderToSection("Energy Consumption", "Moving Energy Consumption", SimulationScript.Instance.CoSh.MinMoveEnergyConsumption, SimulationScript.Instance.CoSh.MaxMoveEnergyConsumption, false, 0f, 15f, (min, max) => { SimulationScript.Instance.CoSh.MinMoveEnergyConsumption = min; SimulationScript.Instance.CoSh.MaxMoveEnergyConsumption = max; });
        ...
        AddSliderToSection("Species", "Species Logging Rate", SimulationScript.Instance.CoSh.SpeciesLoggingRate, false, 5f, 60f * 10f, o => SimulationScript.Instance.CoSh.SpeciesLoggingRate = o);
